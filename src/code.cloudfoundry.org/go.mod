...
require (
	...
	code.cloudfoundry.org/diego-logging-client v0.0.0-20221010192039-bce9fb4354a3
	...
	code.cloudfoundry.org/silk v0.0.0-20221018140952-a937478821fa
...
require (
	code.cloudfoundry.org/bbs v0.0.0-20220928214406-6d44a4df0134 // indirect
	code.cloudfoundry.org/clock v1.0.0 // indirect
	code.cloudfoundry.org/go-diodes v0.0.0-20221017175818-728392b37655 // indirect
	code.cloudfoundry.org/locket v0.0.0-20220920165427-933b89909aba // indirect
